...
If you get the warning ``Duplicate target name``, because of multiple links with the same label, see `Create anonymous links <SPHINX-TIPS.rst#create-anonymous-links>`_.
